---
title: 使用Gatsby主题Narative
author: CYRON
date: 2019-05-01
hero: ./images/hero-2.jpg
excerpt: Gatsby是一款了不起的构建工具。
...
但是，建立和发展业务不仅需要好主意。 人们需要将它们带入现实。 那些人是在协作和共享他们的专业知识，还是在发生冲突并将其保留给自己？ 他们是否有必要的资源来执行他们的想法？ 还是他们不断地承受压力，以最低限度的手段只摘下悬空最薄的果实，同时将最大的野心放在后燃炉上？
